...
function Login() {
  ...
  return (
    <div
      className="w-screen h-screen flex items-center justify-start bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      <div className="w-full h-full flex items-center justify-start pl-10 md:pl-16 lg:pl-24">
        <div className="bg-white rounded-3xl shadow-2xl p-10 w-full max-w-md flex flex-col gap-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[#1a2f5e] font-bold text-sm tracking-widest uppercase">Grupo Víquez.</span>
          </div>

          <div>
            <h1 className="text-4xl font-black text-[#1a2f5e] leading-tight">Bienvenido</h1>
            <p className="text-gray-500 text-sm mt-1">Accede a tu portal corporativo</p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <a href="#" className="text-xs text-[#c9a227] hover:underline">¿Olvidaste tu contraseña?</a>
              </div>
              <div className="flex items-center border border-gray-300 rounded-xl px-3 py-3 gap-2 focus-within:border-[#c9a227] transition-colors">
                <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="remember" className="text-sm text-gray-700 cursor-pointer select-none">Recordarme</label>
          </div>
          ...
          <p className="text-xs text-center text-gray-400">
            ...
            <a href="#" className="text-[#c9a227] hover:underline">Términos y Condiciones</a>
          </p>
        </div>
      </div>
    </div>
