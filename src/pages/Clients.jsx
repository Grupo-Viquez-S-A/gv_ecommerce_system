                  ...
                  {form.branches.map((branch, idx) => (
                    <div key={idx} className="bg-[#0f1623] border border-[#1f2a40] rounded-xl p-3 space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-[#141a2a] border border-[#1f2a40] rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#2563eb] transition-colors"
                      />
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-[#141a2a] border border-[#1f2a40] rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-[#2563eb] transition-colors"
                        />
                        <input
                          type="text"
                          ...
                          {(branch.representatives || []).map((rep, rIdx) => (
                            <div key={rIdx} className="bg-[#141a2a] border border-[#1f2a40] rounded-lg p-2 space-y-2">
                              ...
                              <input
                                ...
                                className="w-full bg-[#0f1623] border border-[#1f2a40] rounded-lg px-3 py-1.5 text-xs text-white placeholder-gray-600 focus:outline-none focus:border-[#2563eb] transition-colors"
                              />
                              <div className="flex gap-2">
                                <input
                                  type="text"
                                  ...
                                  className="flex-1 bg-[#0f1623] border border-[#1f2a40] rounded-lg px-3 py-1.5 text-xs text-white placeholder-gray-600 focus:outline-none focus:border-[#2563eb] transition-colors"
                                />
                                <input
                                  type="tel"
                                  placeholder="Teléfono"
                ...
                <div className="px-6 py-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {(repModal.branches || []).map((branch, idx) => (
                      <div key={idx} onClick={() => setSelectedRepBranch(branch)} className="bg-[#0f1623] border border-[#1f2a40] rounded-xl p-4 hover:border-[#2563eb]/50 cursor-pointer transition-colors">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-8 h-8 rounded-full bg-[#1e3a5f] flex items-center justify-center text-[#60a5fa] flex-shrink-0">
                            <RiMapPinFill size={14} />
                          </div>
