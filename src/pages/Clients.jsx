...
export default function Clients() {
  ...
  const openCreateDrawer = () => {
    ...
    setEditClient(null);
    setViewClient(null);
    setForm({ name: "", email: "", phone: "", company: "", address: "", status: "Activo", notes: "", branches: [{ name: "", phone: "", address: "" }] });
    setDrawerOpen(true);
  };
  ...
  const openEditDrawer = (c) => {
    ...
    setEditClient(c);
    setViewClient(null);
    setForm({ name: c.name, email: c.email, phone: c.phone, company: c.company, address: c.address, status: c.status, notes: c.notes || "", branches: c.branches?.length ? c.branches : [{ name: "", phone: "", address: "" }] });
    setDrawerOpen(true);
  };
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => setForm({ ...form, branches: [...form.branches, { name: "", phone: "", address: "" }] })}
